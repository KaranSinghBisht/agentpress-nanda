...
export function EditionHero({ edition }: { edition: EditionPreview | null }) {
  ...
  return (
    <article className="newsprint-texture border border-ink bg-paper">
      <div className="border-b border-ink px-6 py-2 font-mono text-[10px] uppercase tracking-widest text-neutral-600">
      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          ...
          <span className="font-mono text-[10px] uppercase tracking-widest text-neutral-500">
            Agents pay 5 credits via API — this is the showroom copy
          </span>
        </div>
      </div>
    </article>
